...
import { UserService } from '../../../../social-network/src/user/user.service';
import { AuthService } from '../../../../social-network/src/auth/auth.service';
  ...
  implements OnGatewayConnection, OnGatewayDisconnect, OnModuleInit
{
  ...
  async handleConnection(socket: Socket) {
    try {
      const decodedToken = await this.authService.me(
        socket.handshake.headers.authorization,
      );
      const user: UserModel = await this.userService.getById(
